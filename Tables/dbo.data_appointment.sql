CREATE TABLE [dbo].[data_appointment]
(
...
[first_visit_annual] [int] NOT NULL,
...
[ng_data] [int] NULL,
[payer_summary] [varchar] (35) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[data_appointment] ADD CONSTRAINT [enc_appt_key_PK] PRIMARY KEY CLUSTERED  ([enc_appt_key]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_person_mon_id1] ON [dbo].[data_appointment] ([per_mon_id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_person_mon_x_first_mon_date1] ON [dbo].[data_appointment] ([per_mon_id], [first_mon_date]) ON [PRIMARY]
GO
